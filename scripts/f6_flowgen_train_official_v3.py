...
CONTRACT_ID = "f6_flowgen_official_train_v3"
...
PREFERRED_POLICY_ORDER = [
    "F04_e33_lowmmd_c1",
    "F05_e34_lowmmd_c1",
    "H05_bridge300_lowmmd_c1",
    "H06_bridge400_lowmmd_c1",
    "J02_e18_mmdxy_light_c1",
    "K03_e18_ksy_c1",
    "R01_e18_ramp_c1",
    "K02_f02_ksy_lowmmd_c2",
    "J03_f02_mmdxy_light_lowmmd_c2",
    "K03_h02_bridge500_ksy_lowmmd_c2",
]
...
FLOWGEN_OFFICIAL_POLICY_SPECS = {
    "F04_e33_lowmmd_c1": {
        ...
        "historical_origin": (
            "Explicit official v3 c1 frontier probe. It ports the successful c2_F01 low-MMD recipe to the c1 base "
            "without adding extra loss terms, to test whether c1 simply needs the same frontier region."
        ),
        "historical_source_run_ids": [
            "flowgen_tpv1_c2_train_f01_e33_lowmmd_seed2468_v2",
        ],
    },
    "F05_e34_lowmmd_c1": {
        "allowed_base_tokens": ["c1"],
        ...
        "historical_origin": (
            "Explicit official v3 c1 frontier probe. It ports the balanced c2_F02 low-MMD recipe to the c1 base "
            "as the main test of whether c1 was underexplored in the strongest c2 region."
        ),
        "historical_source_run_ids": [
            "flowgen_tpv1_c2_train_f02_e34_lowmmd_seed2468_v2",
        ],
    },
    "H05_bridge300_lowmmd_c1": {
        "allowed_base_tokens": ["c1"],
        ...
        "historical_origin": (
            "Explicit official v3 c1 bridge probe. It ports the c2_H01 bridge policy to c1 to test whether the "
            "c1 base prefers a much softer realism regime than the failed c1_H04 bridge500 attempt."
        ),
        "historical_source_run_ids": [
            "flowgen_tpv1_c2_train_h01_bridge300_lowmmd_seed2468_v2",
            "flowgen_tpv1_c1_train_h04_bridge500_lowmmd_seed9101_v2",
        ],
    },
    "H06_bridge400_lowmmd_c1": {
        "allowed_base_tokens": ["c1"],
        ...
        "historical_origin": (
            "Explicit official v3 c1 bridge probe. It fills the missing 400/40 bridge point between the low-W1 "
            "A45 regime and the harsher c1_H04 bridge500 setting."
        ),
        "historical_source_run_ids": [
            "flowgen_tpv1_c1_train_a45_seed9101_v1",
            "flowgen_tpv1_c1_train_h04_bridge500_lowmmd_seed9101_v2",
        ],
    },
    "J02_e18_mmdxy_light_c1": {
        ...
        "historical_origin": (
            "Explicit official v3 c1 joint-XY probe. It keeps the good c1_E18 anchor intact and adds only a light "
            "MMD_XY term to test whether c1 mainly lacks joint-structure realism."
        ),
        "historical_source_run_ids": [
            "flowgen_tpv1_c1_train_e18_seed9101_v1",
            "flowgen_tpv1_c2_train_j01_e18_mmdxy_light_seed2468_v2",
        ],
    },
    "K03_e18_ksy_c1": {
        "allowed_base_tokens": ["c1"],
        ...
        "historical_origin": (
            "Explicit official v3 c1 KS-Y probe. It keeps the c1_E18 anchor unchanged and adds only the light KS-Y "
            "term that worked well on c2, isolating that interaction cleanly on c1."
        ),
        "historical_source_run_ids": [
            "flowgen_tpv1_c1_train_e18_seed9101_v1",
    ...
    "R01_e18_ramp_c1": {
        ...
        "historical_origin": (
            "Explicit official v3 c1 scheduling probe. It preserves the c1_E18 loss mix and changes only the "
            "realism activation schedule to test whether c1 is being overconstrained too early."
        ),
        "historical_source_run_ids": [
            "flowgen_tpv1_c1_train_e18_seed9101_v1",
        ],
    ...
    "K02_f02_ksy_lowmmd_c2": {
        ...
        "historical_origin": (
            "Explicit official v3 c2 combination probe. It starts from the balanced c2_F02 low-MMD setting and adds "
            "the light KS-Y term that drove strong gains in c2_K01."
        ),
        "historical_source_run_ids": [
            "flowgen_tpv1_c2_train_f02_e34_lowmmd_seed2468_v2",
            "flowgen_tpv1_c2_train_k01_e36_ksy_seed2468_v2",
    ...
    "J03_f02_mmdxy_light_lowmmd_c2": {
        ...
        "historical_origin": (
            "Explicit official v3 c2 combination probe. It starts from c2_F02 and adds only the light MMD_XY term "
            "that already looked promising in c2_J01."
        ),
        "historical_source_run_ids": [
            "flowgen_tpv1_c2_train_f02_e34_lowmmd_seed2468_v2",
            "flowgen_tpv1_c2_train_j01_e18_mmdxy_light_seed2468_v2",
    ...
    "K03_h02_bridge500_ksy_lowmmd_c2": {
        ...
        "historical_origin": (
            "Explicit official v3 c2 combination probe. It takes the balanced bridge c2_H02 regime and adds the "
            "light KS-Y term to test whether the K-style gain also exists away from the high-W1 frontier."
        ),
        "historical_source_run_ids": [
...
def _parse_args() -> argparse.Namespace:
    ap = argparse.ArgumentParser(
        description=(
            "Canonical official FlowGen trainer v3 for the current base-trained phase. "
            "It starts from the two official FlowGen bases and applies the explicit "
            "official v3 exploration policy set derived from the current official analysis."
        )
    )
...
def _run_id_for(base: BaseContext, policy: OfficialPolicy, run_seed: int) -> str:
    ...
    return f"flowgen_tpv1_{base.token}_train_{policy_slug}_seed{int(run_seed)}_v3"
...
def _build_config_payload(*, base: BaseContext, policy: OfficialPolicy, run_seed: int) -> dict[str, Any]:
    ...
    return {
        ...
        "seed": int(run_seed),
        "official_training": {
            "mode": "flowgen_official_base_finetune_v3",
            "policy_set_id": "flowgen_official_v3_exploration",
...
def _build_evaluation_context(*, base: BaseContext, policy: OfficialPolicy, run_seed: int) -> dict[str, Any]:
    ...
    return {
        ...
        "seed_set_id": f"f6_flowgen_official_v3_{base.token}_seed{int(run_seed)}",
...
def _print_plan_summary(
    *,
    ...
    print("\n" + "=" * 100)
    print("FlowGen official training campaign v3")
    ...
    print("  - provenance remains metadata only; every v3 policy is explicit in this file")

    print("\nCanonical v3 campaign (10 runs):")
    ...
    print("\nPlan counts:")
    print(f"  - canonical v3 runs: {canonical_counts['planned_total']}")
...
def _resolve_entry_by_run_id(entries: list[PlanEntry], run_id: str) -> PlanEntry:
    ...
    if not matches:
        raise RuntimeError(f"Run id not found in current FlowGen official v3 plan: {run_id}")
    if len(matches) != 1:
        raise RuntimeError(f"Run id appears multiple times in current FlowGen official v3 plan: {run_id}")
    return matches[0]
...
def main() -> int:
    ...
    if not entries:
        raise RuntimeError("No official FlowGen v3 runs remain after filtering.")
    ...
    if args.run_one:
        ...
        print(f"Running isolated FlowGen official v3 run: {entry.run_id}")
        _run_one(
        ...
        print(f"Completed isolated FlowGen official v3 run: {entry.run_id}")
        return 0

    SUMMARY_ROOT.mkdir(parents=True, exist_ok=True)
    campaign_id = f"flowgen_train_official_v3_tpv1_base_seeds_{_campaign_timestamp()}"
    ...
    plan_payload = {
        ...
        "canonical_v3_runs": [asdict(entry) for entry in canonical_entries],
    ...
    print("\n" + "=" * 100)
    print(f"Starting official FlowGen v3 training | planned runs={len(entries)}")
    ...
    print("\n" + "=" * 100)
    print("Official FlowGen v3 training finished")
